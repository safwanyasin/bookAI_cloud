                          ...
                          children: [
                            ...
                            Align(
                                ...
                                child: BookPictureFrame(
                                    imageUrl:
                                        widget.details.imageUrl.getOrCrash())),
                            SizedBox(height: 10.h),
                            Heading(
                                content: widget.details.bookName.getOrCrash()),
                            SizedBox(height: 2.h),
                            Subheading(
                                content:
                            ...
                            Row(
                              ...
                              children: [
                                buildStarRating(
                                    widget.details.rating.getOrCrash(), 14.w),
                                SizedBox(width: 5.w),
                                Text(
                            ...
                            InfoBox(infoList: [
                              ...
                              InfoItem(
                                heading: widget.details.language.getOrCrash(),
                                subheading: 'Language',
                              ),
                              InfoItem(
                                heading:
                            ...
                            Align(
                              ...
                              child: RichText(
                                ...
                                TextSpan(
                                  text: widget.details.publisher.getOrCrash(),
                            ...
                            Align(
                              ...
                              child: RichText(
                                ...
                                TextSpan(
                                  text: widget.details.category.getOrCrash(),
                                  style: Theme.of(context).textTheme.labelSmall,
                                ),
                              ])),
                            ),
                            Align(
                              ...
                              child: RichText(
                                ...
                                TextSpan(
                                    text:
                                        widget.details.description.getOrCrash(),
                                    style:
                                        Theme.of(context).textTheme.labelSmall)
                              ])),
                            ),
